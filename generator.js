...
var EXERCISE_DB=[
  ...
  {id:'db_goblet',name:'Goblet squat',muscle:'Cvadriceps',pattern:'squat',equipment:['gantere'],level:1,compound:true,starEligible:true,prio:2,
  ...
  {id:'gym_leg_press',name:'Presă picioare (leg press)',muscle:'Cvadriceps',pattern:'squat',equipment:['aparate'],level:1,compound:true,starEligible:true,prio:3,
  ...
  {id:'db_sumo',name:'Sumo squat cu ganteră',muscle:'Cvadriceps + interior',pattern:'squat',equipment:['gantere'],level:1,compound:true,starEligible:false,prio:4,
  ...
  // ── PULL (spate) ──
  {id:'db_ramat_sprijinit',name:'Ramat gantere sprijinit pe bancă înclinată',muscle:'Spate',pattern:'pull',equipment:['gantere','banca'],level:1,compound:true,starEligible:true,prio:3,
  ...
  {id:'bara_bent_over_row',name:'Bent-over row cu bara',muscle:'Spate',pattern:'pull',equipment:['bara'],level:2,compound:true,starEligible:true,prio:5,risky:true,
  ...
  {id:'gym_seated_row',name:'Ramat la cablu șezând (seated row)',muscle:'Spate',pattern:'pull',equipment:['cablu'],level:1,compound:true,starEligible:true,prio:4,
  ...
  {id:'bw_row_masa',name:'Ramat inversat sub masă',muscle:'Spate',pattern:'pull',equipment:[],level:2,compound:true,starEligible:true,prio:6,
  ...
  {id:'bw_prosop_row',name:'Ramat cu prosop la ușă',muscle:'Spate',pattern:'pull',equipment:[],level:1,compound:true,starEligible:true,prio:9,
  ...
  {id:'db_reverse_fly',name:'Reverse fly cu gantere',muscle:'Umăr posterior',pattern:'spate_post',equipment:['gantere'],level:1,compound:false,starEligible:false,prio:2,
   ghid:{start:'Aplecat cu trunchiul cât mai aproape de PARALEL cu podeaua (spatele drept) sau cu pieptul sprijinit pe banca înclinată — gantere atârnând, coate ușor îndoite și fixe.',move:'Deschizi brațele lateral până la linia umerilor, strângi omoplații 1 sec, cobori lent.',err:'Trunchi prea vertical (la 45° preia trapezul, nu umărul posterior). Balans, greutate prea mare, coate care se îndoaie (devine ramat).',tip:'Cu cât ești mai orizontal, cu atât lucrează mai mult umărul posterior. Greutate mică — mușchiul e mic. Degetele mari în sus (priza neutră) activează mai bine (Schoenfeld 2013).'}},
